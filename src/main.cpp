...
uint256 hashGenesisBlock("0xc76c559e80e9f39499979a5c82bac26c8a06eb8c830c0b45f9178b003e7bda66");
...
const string strMessageMagic = "GerardoCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 4 * 60; // GerardoCoin: 0.35 days    // TIEMPO EN REAJSUTAR LA DIFICULTAD DE LA MINERIA / ES PROPORCIONAL AL NUMERO DE MONEDAS EXISTENTES
static const int64 nTargetSpacing = 30; // GerardoCoin: 10 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal GerardoCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GerardoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "primer dia de GerardoCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1511030576;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088741190;
        ...
        assert(block.hashMerkleRoot == uint256("0x67e4aa895e31d8f9727c6f75a17fd93a29d0a11d91cc0328f16ec51d777aef26"));
